...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
from pytest_beartype_test._util.pytroar import PytestBeartypeTestPathException
...
def DirRelative(parent_dir: Path, relative_dirname: str) -> Path:
    ...
    Raises
    ------
    PytestBeartypeTestPathException
    ...
    if not subdir.is_dir():
        raise PytestPytestBeartypeTestPathException(
...
def FileRelative(parent_dir: Path, relative_filename: str) -> Path:
    ...
    if not file.is_file():
        raise PytestBeartypeTestPathException(f'File "{file}" not found.')
